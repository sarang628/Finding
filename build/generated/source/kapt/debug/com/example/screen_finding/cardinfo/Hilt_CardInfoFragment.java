...
public abstract class Hilt_CardInfoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CardInfoFragment() {
    super();
  }

  Hilt_CardInfoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CardInfoFragment_GeneratedInjector) this.generatedComponent()).injectCardInfoFragment(UnsafeCasts.<CardInfoFragment>unsafeCast(this));
    }
  }
