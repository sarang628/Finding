...
public abstract class Hilt_FindFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FindFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FindFragment_GeneratedInjector) this.generatedComponent()).injectFindFragment(UnsafeCasts.<FindFragment>unsafeCast(this));
    }
  }
