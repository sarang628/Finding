 ...
 */
@Composable
fun FindScreen(onZoomIn: () -> Unit, onZoomOut: () -> Unit, restaurantCardPage: @Composable () -> Unit, mapScreen: @Composable () -> Unit, filter: @Composable () -> Unit, myLocation: @Composable () -> Unit, buttonBottomPadding : Dp = 24.dp, onChangeRestaurantCardPageHeight : (Int) -> Unit = {}) {
    Box {
